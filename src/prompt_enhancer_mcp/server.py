...
async def enhance_task(task: str, ctx: Context, project_id: str = None) -> str:
    ...
    IMPORTANT: Do NOT read, scan, or explore the local codebase before or after calling this tool.
    Do NOT list files, read file contents, or analyze project structure.
    This tool fetches context from remote project documentation — no local file access is needed.
    Simply call this tool, return the result to the user, and STOP. Wait for user confirmation
